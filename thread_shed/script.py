...
for daily_transaction in daily_transactions_split:
    clean_daily_transaction = []

    for transaction_detail in daily_transaction:
        clean_transaction_detail = transaction_detail.strip()
        clean_daily_transaction.append(clean_transaction_detail)

    transactions_clean.append(clean_daily_transaction)
